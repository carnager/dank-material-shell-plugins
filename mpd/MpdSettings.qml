...
PluginSettings {
    ...
    StringSetting {
        ...
        label: "Clerk API"
        description: "Clerk API target used for album ratings and random playback. Accepts local, host:port, a Unix socket path, or a full URL. Leave empty to read ~/.config/clerk/clerk-rofi.toml"
        placeholder: "local"
        defaultValue: ""
    }
